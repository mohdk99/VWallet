...
class update_qr_barcode_scanner extends StatefulWidget {
  update_qr_barcode_scanner({Key? key}) : super(key: key);

  @override
  State<update_qr_barcode_scanner> createState() =>
      _update_qr_barcode_scannerState();
}

class _update_qr_barcode_scannerState extends State<update_qr_barcode_scanner> {
  ...
  void addItem(code, String value, int index) async {
    String test = 'test';
    final newIndex = 0;
  ...
  _qrCallback(String? code) {
    setState(() {
      ...
      if (documentNumber[currentIndex] != code) {
        ...
        ElegantNotification.error(
                ...
                title: Text("Denied"),
                description: Text("Document does not match"))
            .show(context);
      } else if (documentNumber[currentIndex] == code) {
        ...
        singleInputDialog(
          ...
          positiveButtonAction: (value) {
            ...
            if (documentNumber[currentIndex] != code) {
              ...
              addItem(code, value.toString(), currentIndex);
              Navigator.pop(context);
              ...
              /*ElegantNotification.success(
                      ...
                      height: 70,
                      animation: ANIMATION.fromTop,
                      title: Text("Updated Loyalty Card"),
                      description: Text("You updated the card successfully"))
                  .show(context);*/
            }
          },
          /*titleIcon: Icon(
